      ...
      <main>
          ...
          <div className="main-info-grid">
            ...
            <div className="training-info">
              ...
              <div className="training-info-content info-grid">
                ...
                <p className="padding-field-name">Role*</p>
                <div className = "training-info">
                  <textarea rows="1" cols="40" className="textarea-small" placeholder="student" disabled></textarea>
                  <div className="lock-icon"><LockIcon /></div>
                </div>

                <p className="padding-field-name">Specialism*</p>
                <div className="training-info">
                  <textarea rows="" cols="40" className="textarea-small" placeholder="Software Developer" disabled></textarea>
                  <div className="lock-icon"><LockIcon /></div>
                </div>

                <p className="padding-field-name">Cohort*</p>
                <div className="training-info">
                  <textarea rows="" cols="40" className="textarea-small" placeholder="Cohort 4" disabled></textarea>
                  <div className="lock-icon"><LockIcon /></div>
                </div>

                <p className="padding-field-name">Start Date*</p>
                <div className="training-info">
                  <textarea rows="" cols="40" className="textarea-small" placeholder="January 2023" disabled></textarea>
                  <div className="lock-icon"><LockIcon /></div>
                </div>

                <p className="padding-field-name">End Date*</p>
                <div className="training-info">
                  <textarea rows="" cols="40" className="textarea-small" placeholder="January 2023" disabled></textarea>
                  <div className="lock-icon"><LockIcon /></div>
                </div>
            ...
            <div className="contact-info">
              ...
              <div className="contact-info-content info-grid">
                ...
                <div className="padding-top"></div>
                <p>Email*</p>
                <textarea cols="40" className="textarea-small" placeholder="alex.walker@boolean.co.uk" disabled></textarea>
                <div className="padding"></div>
                <p>Mobile*</p>
                <textarea cols="40" className="textarea-small" placeholder="07890 123456" disabled></textarea>
                <div className="padding"></div>
                <p>Password*</p>
                <div class="input-container">
                  <textarea rows="10" cols="40" class="textarea-small" name="password" placeholder="***************" disabled required></textarea>
                    <svg
        ...
        <div className="bio">
          <div className="bio-content">
            ...
            <div className="padding-top"></div>
            <p>Bio</p>
            <textarea placeholder="Tell us about yourself, your professional and educational highlights to date..." spellCheck="false"></textarea>
            <small>0/300</small>
          </div>
          
          <div class="button-container">
          <button type="button" class="button offwhite">Cancel</button>
          <button type="button" class="button blue">Save</button>
        </div>
        </div>
